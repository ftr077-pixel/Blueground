...
const APARTMENTS: Array<[number, string]> = [
  ...
  [51, "Nahalat Beniamin 9, 3"],
  [52, "Nahalat Beniamin 9, 4"],
  [53, "Nahalat Beniamin 9, 5"],
  [54, "Nahalat Beniamin 9, 6"],
  [55, "Nahalat Beniamin 9, 7"],
  [56, "Nahalat Beniamin 9, 8"],
  [57, "Nahalat Beniamin 9, 9"],
  [58, "Nahalat Beniamin 9, 10"],
